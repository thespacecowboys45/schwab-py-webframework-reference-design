...
def accounts():
    return render_template('accounts/accounts.html', base_template=g.base_template, title="Accounts")
...
def get_accounts():
    ...
    # Stubbed account data
    stub_data = [
        {"name": "Primary Account", "id": "123456789"},
        {"name": "Savings Account", "id": "987654321"}
    ]

    services.accounts.get_account_info()
